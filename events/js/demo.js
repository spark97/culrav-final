(function() {
    var eventslist = ["../subevents/rangmanch", "../subevents/rangsaazi", "../subevents/litmuse", "../subevents/literary", "../subevents/spandhan", "../subevents/razmatazz", "#", "../subevents/anunaad","../MUN"]
